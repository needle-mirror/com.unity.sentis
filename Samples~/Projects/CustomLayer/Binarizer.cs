...
public class Binarizer : Layer
{
    ...
    public override Tensor Execute(Tensor[] inputs, ExecutionContext ctx)
    {
        ...
        using var thresholdTensor = ctx.ops.ConstantOfShape(new TensorShape(), threshold);
