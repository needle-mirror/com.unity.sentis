...
public interface IBackend : IDisposable
{
    ...
    /// <returns>The computed output tensor.</returns>
    TensorFloat Conv(TensorFloat X, TensorFloat K, TensorFloat B, int groups, Span<int> strides, Span<int> pads, Span<int> dilations, Layers.FusableActivation fusedActivation);
    ...
    /// <returns>The computed output tensor.</returns>
    TensorFloat Resize(TensorFloat X, ReadOnlySpan<float> scale, Layers.InterpolationMode interpolationMode, Layers.NearestMode nearestMode = Layers.NearestMode.RoundPreferFloor, Layers.CoordTransformMode coordTransformMode = Layers.CoordTransformMode.HalfPixel);
    ...
    /// <returns>The computed output tensor.</returns>
    TensorFloat Pad(TensorFloat X, ReadOnlySpan<int> pad, Layers.PadMode padMode = Layers.PadMode.Constant, float constant = 0.0f);
    ...
    /// <summary>
    /// Called after every layer execution. It allows IBackend to run cleanup operations
